...
### F1 · 数据拉取（单数据源 iCal，详见 04-api-spec.md）
- F1.1 解析 Canvas 个人日历订阅（.ics），无需 Token
- F1.2 F5.3「自动检测已提交」**不可用**，改为本地持久化的手动「标记提交」
- F1.3 起因：UCLA Extension 管理员禁止学生自助生成 Access Token
- F1.4 Token/REST 方案代码已于 2026-05-16 删除（曾作为备选，确认用不到）
